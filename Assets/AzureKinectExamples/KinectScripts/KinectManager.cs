...
namespace com.rfilkov.kinect
{
    ...
    public class KinectManager : MonoBehaviour
    {
        ...
        {
//            Debug.Log("In GetLeftHandState, ContainsKey=" +userManager.dictUserIdToIndex.ContainsKey(userId));
            if (userManager.dictUserIdToIndex.ContainsKey(userId))
            {
                int index = userManager.dictUserIdToIndex[userId];
//                Debug.Log("  index=" + index + " bIsTracked=" + alTrackedBodies[index].bIsTracked + " state=" + alTrackedBodies[index].leftHandState);
