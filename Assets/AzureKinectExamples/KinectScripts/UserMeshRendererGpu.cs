...
namespace com.rfilkov.components
{
    ...
    public class UserMeshRendererGpu : MonoBehaviour
    {
        ...
        private void InitMesh()
        {
            ...
            if (sensorData != null && sensorData.sensorInterface != null && meshShaderMat != null)
            {
                ...
                else
                {
                    ...
                    {
                        if (sensorData.colorInfraredBuffer == null && sensorData.colorImageWidth > 0 && sensorData.colorImageHeight > 0)
                        {
                            int bufferLength = sensorData.colorImageWidth * sensorData.colorImageHeight / 2;
                ...
                {
                    if (sensorData.colorBodyIndexBuffer == null && sensorData.colorImageWidth > 0 && sensorData.colorImageHeight > 0)
                    {
